...
public class Season {
	...
	private static final int WRITE_COUNT = 531441 * 3;
	...
	public void loadResults() {
		String[][] stringResults = {
				...
				{ "CORB", "NCU", "2", "1"}, 
				{ "OIT", "ESC", "2", "0" },  { "SOU", "NW", "2", "1" },{ "RMC", "CORB", "1", "2" }, { "CI", "NCU", "1", "0" },
				{ "OIT", "NW" , "0", "1"}, { "SOU", "ESC" , "1", "0" } , { "CI", "CORB" , "1", "2" }, { "RMC", "NCU", "1", "0"  }, 
				{ "EOU", "WPAC", "1", "0" },
				{ "UP", "CC" , "0", "1"},{ "NW", "CC", "0", "1" },{ "ESC", "CC", "0", "1" }
		};
		...
		if (firstTime) {
			int left = 66-stringResults.length;
			System.out.println(left);
			System.out.println((int)Math.pow(3,left));
			System.out.println((int)Math.pow(3,left)/WRITE_COUNT);
			firstTime = false;
		}
	}
...
//			}
	...
	static public void gameIteration() {
		...
		while (pg.hasMore()) {
			...
			opponent[standings.get(8).ordinal()]++;
			opponent[standings.get(9).ordinal()]++;
			opponent[standings.get(10).ordinal()]++;
			opponent[standings.get(11).ordinal()]++;
